...
public class FarlandsHumSound extends AbstractSoundInstance implements TickableSoundInstance {
    private static final float BASE_VOLUME = 0.4f;
    private final PlayerEntity player;
    private boolean done = false;

    public FarlandsHumSound(PlayerEntity player) {
        super(MasksNGlorySounds.AMBIENT_FARLANDS_HUM, SoundCategory.AMBIENT, Random.create());
        this.player = player;
        this.repeat = true;
        this.repeatDelay = 0;
