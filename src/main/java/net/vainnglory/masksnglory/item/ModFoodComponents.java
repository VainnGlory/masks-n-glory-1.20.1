...
public class ModFoodComponents {
    ...
    public static final FoodComponent ECHO_CARAMEL = new FoodComponent.Builder().hunger(2).saturationModifier(2)
            .statusEffect(new StatusEffectInstance(ModEffects.SUGAR_RUSH, 400, 0), 1.0F).alwaysEdible().build();
    ...
    public static final FoodComponent MARROWED_BONES = new FoodComponent.Builder().hunger(10).saturationModifier(0.7f)
            .alwaysEdible()
            .build();
