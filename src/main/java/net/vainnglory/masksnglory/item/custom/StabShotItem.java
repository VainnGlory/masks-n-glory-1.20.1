...
public class StabShotItem extends Item {
    ...
    private void fireStabShot(ServerWorld world, PlayerEntity user) {
        ...
        StabShotManager.schedule(world, impactPos.x, impactPos.z, DETONATION_DELAY_TICKS);
    }
}