...
public class RustedSwordItem extends SwordItem implements Vanishable, CustomHitSoundItem, ModDeathSource {
    ...
    public RustedSwordItem(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings, ModRarities rarity) {
        ...
        builder.put(
                ...
                new EntityAttributeModifier(ATTACK_DAMAGE_MODIFIER_ID, "Weapon modifier", 6.5, EntityAttributeModifier.Operation.ADDITION)
        );
        builder.put(
    ...
    public Text getName(ItemStack stack) {
        ...
        if (EnchantmentHelper.getLevel(ModEnchantments.LOCKOUT, stack) > 0) {
            return super.getName(stack).copy().styled(style -> style.withColor(0xFFB090));
        }
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        tooltip.add(Text.translatable("tooltip.masks-n-glory.rusted_sword"));
